    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<AppDbContext>(options =>
                options.UseInMemoryDatabase("PersonalBookLibrary"));

            services.AddScoped<IRepository<Book>, EfCoreBookRepository>();
            services.AddScoped<IRepository<Author>, EfCoreAuthorRepository>();
            ...
            services
                .AddControllersWithViews(config => config.Filters.Add(typeof(BookExceptionFilter)))
